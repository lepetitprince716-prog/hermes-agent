...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    # Last full live sync: 2026-09-16 (38 models).
    "opencode-go": [
        "kimi-k3", "kimi-k2.7-code", "kimi-k2.6", "kimi-k2.5", "gpt-5.6-luna", "grok-4.6", "grok-4.5",
        "glm-5.3", "glm-5.3-flash", "glm-5.2", "glm-5.1", "glm-5", "mimo-v2.5-pro", "mimo-v2.5",
        "mimo-v2-pro", "mimo-v2-omni", "minimax-m3", "minimax-m2.7", "minimax-m2.5", "longcat-2.0",
        "deepseek-v4-pro", "deepseek-v4-flash", "deepseek-v4.1-flash", "deepseek-v4-flash-vision-exp",
        "deepseek-flash", "qwen3.8-max", "qwen3.8-flash", "qwen3.7-max", "qwen3.7-plus",
        "qwen3.6-plus", "qwen3.5-plus", "hy4-preview", "hy3", "hy3-preview",
        "muse-spark-1.2-contributor", "muse-spark-1.3-contributor", "union-alpha", "omen-alpha",
    ],
    "kilocode": [
